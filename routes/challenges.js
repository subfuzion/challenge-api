        ...
        if (err) {
          ...
          if (challenge) {
            ...
            res.render('challengeDetail', {
              title: challenge.title, imageURL: challenge.image_url, poster: challenge.poster, summary: challenge.summary, prizeMoney: '$' + challenge.prize_money, submissionPeriodStartDate: challenge.submission_period_start_date, submissionPeriodEndDate: challenge.submission_period_end_date, winnersAnnouncedDate: challenge.winners_announced_date
            });
          } else {
            res.end();
          }
